...
#include "custom_msgs/srv/detail/can_service__rosidl_typesupport_fastrtps_cpp.hpp"
...
cdr_serialize(
  const custom_msgs::srv::CanService_Request & ros_message,
...
cdr_deserialize(
  eprosima::fastcdr::Cdr & cdr,
  custom_msgs::srv::CanService_Request & ros_message)
{
  // Member: can_id
  cdr >> ros_message.can_id;
  ...
  size_t current_alignment)
{
  ...
  if (is_plain) {
    ...
    using DataType = custom_msgs::srv::CanService_Request;
    is_plain =
      (
...
{
  auto typed_message =
    static_cast<const custom_msgs::srv::CanService_Request *>(
    untyped_ros_message);
...
{
  auto typed_message =
    static_cast<custom_msgs::srv::CanService_Request *>(
    untyped_ros_message);
...
{
  return &custom_msgs::srv::typesupport_fastrtps_cpp::_CanService_Request__handle;
}
...
const rosidl_message_type_support_t *
ROSIDL_TYPESUPPORT_INTERFACE__MESSAGE_SYMBOL_NAME(rosidl_typesupport_fastrtps_cpp, custom_msgs, srv, CanService_Request)() {
  return &custom_msgs::srv::typesupport_fastrtps_cpp::_CanService_Request__handle;
}
...
ROSIDL_TYPESUPPORT_FASTRTPS_CPP_PUBLIC_custom_msgs
cdr_serialize(
  const custom_msgs::srv::CanService_Response & ros_message,
  eprosima::fastcdr::Cdr & cdr)
{
  // Member: success
...
cdr_deserialize(
  eprosima::fastcdr::Cdr & cdr,
  custom_msgs::srv::CanService_Response & ros_message)
{
  // Member: success
  {
    uint8_t tmp;
  ...
  size_t current_alignment)
{
  ...
  if (is_plain) {
    ...
    // We still need to check that the in-memory alignment
    // is the same as the CDR mandated alignment.
    using DataType = custom_msgs::srv::CanService_Response;
    is_plain =
      (
...
{
  auto typed_message =
    static_cast<const custom_msgs::srv::CanService_Response *>(
    untyped_ros_message);
  return cdr_serialize(*typed_message, cdr);
}
...
{
  auto typed_message =
    static_cast<custom_msgs::srv::CanService_Response *>(
    untyped_ros_message);
  return cdr_deserialize(cdr, *typed_message);
}
...
{
  return &custom_msgs::srv::typesupport_fastrtps_cpp::_CanService_Response__handle;
}
...
const rosidl_message_type_support_t *
ROSIDL_TYPESUPPORT_INTERFACE__MESSAGE_SYMBOL_NAME(rosidl_typesupport_fastrtps_cpp, custom_msgs, srv, CanService_Response)() {
  return &custom_msgs::srv::typesupport_fastrtps_cpp::_CanService_Response__handle;
}
...
// functions for custom_msgs::srv::CanService_Request already declared above

// functions for custom_msgs::srv::CanService_Response already declared above
...
ROSIDL_TYPESUPPORT_FASTRTPS_CPP_PUBLIC_custom_msgs
cdr_serialize(
  const custom_msgs::srv::CanService_Event & ros_message,
  eprosima::fastcdr::Cdr & cdr)
{
  // Member: info
  ...
  // Member: request
  {
    ...
    for (size_t i = 0; i < size; i++) {
      custom_msgs::srv::typesupport_fastrtps_cpp::cdr_serialize(
...
cdr_deserialize(
  eprosima::fastcdr::Cdr & cdr,
  custom_msgs::srv::CanService_Event & ros_message)
{
  // Member: info
  ...
  // Member: request
  {
    ...
    for (size_t i = 0; i < size; i++) {
      custom_msgs::srv::typesupport_fastrtps_cpp::cdr_deserialize(
  ...
  size_t current_alignment)
{
  ...
  // Member: request
  {
    ...
    for (size_t index = 0; index < array_size; ++index) {
      current_alignment +=
        custom_msgs::srv::typesupport_fastrtps_cpp::get_serialized_size(
  ...
  size_t current_alignment)
{
  ...
  // Member: request
  {
    ...
    for (size_t index = 0; index < array_size; ++index) {
      ...
      bool inner_is_plain;
      size_t inner_size =
        custom_msgs::srv::typesupport_fastrtps_cpp::max_serialized_size_CanService_Request(
        inner_full_bounded, inner_is_plain, current_alignment);
      last_member_size += inner_size;
      current_alignment += inner_size;
      full_bounded &= inner_full_bounded;
  ...
  // Member: response
  {
    ...
    for (size_t index = 0; index < array_size; ++index) {
      ...
      bool inner_is_plain;
      size_t inner_size =
        custom_msgs::srv::typesupport_fastrtps_cpp::max_serialized_size_CanService_Response(
        inner_full_bounded, inner_is_plain, current_alignment);
      last_member_size += inner_size;
      current_alignment += inner_size;
      full_bounded &= inner_full_bounded;
  ...
  if (is_plain) {
    ...
    // We still need to check that the in-memory alignment
    // is the same as the CDR mandated alignment.
    using DataType = custom_msgs::srv::CanService_Event;
    is_plain =
      (
  ...
  eprosima::fastcdr::Cdr & cdr)
{
  ...
  // Member: request
  {
    ...
    cdr << static_cast<uint32_t>(size);
    for (size_t i = 0; i < size; i++) {
      custom_msgs::srv::typesupport_fastrtps_cpp::cdr_serialize_key(
        ros_message.request[i],
        cdr);
    }
  }
  ...
  size_t current_alignment)
{
  ...
  // Member: request
  {
    ...
    for (size_t index = 0; index < array_size; ++index) {
      current_alignment +=
        custom_msgs::srv::typesupport_fastrtps_cpp::get_serialized_size_key(
        ros_message.request[index], current_alignment);
    }
  }
  ...
  size_t current_alignment)
{
  ...
  // Member: request
  {
    ...
    for (size_t index = 0; index < array_size; ++index) {
      ...
      bool inner_is_plain;
      size_t inner_size =
        custom_msgs::srv::typesupport_fastrtps_cpp::max_serialized_size_key_CanService_Request(
        inner_full_bounded, inner_is_plain, current_alignment);
      last_member_size += inner_size;
      current_alignment += inner_size;
      full_bounded &= inner_full_bounded;
  ...
  // Member: response
  {
    ...
    for (size_t index = 0; index < array_size; ++index) {
      ...
      bool inner_is_plain;
      size_t inner_size =
        custom_msgs::srv::typesupport_fastrtps_cpp::max_serialized_size_key_CanService_Response(
        inner_full_bounded, inner_is_plain, current_alignment);
      last_member_size += inner_size;
      current_alignment += inner_size;
      full_bounded &= inner_full_bounded;
...
{
  auto typed_message =
    static_cast<const custom_msgs::srv::CanService_Event *>(
    untyped_ros_message);
  return cdr_serialize(*typed_message, cdr);
}
...
{
  auto typed_message =
    static_cast<custom_msgs::srv::CanService_Event *>(
    untyped_ros_message);
  return cdr_deserialize(cdr, *typed_message);
}
...
{
  return &custom_msgs::srv::typesupport_fastrtps_cpp::_CanService_Event__handle;
}
...
const rosidl_message_type_support_t *
ROSIDL_TYPESUPPORT_INTERFACE__MESSAGE_SYMBOL_NAME(rosidl_typesupport_fastrtps_cpp, custom_msgs, srv, CanService_Event)() {
  return &custom_msgs::srv::typesupport_fastrtps_cpp::_CanService_Event__handle;
}
...
static const rosidl_service_type_support_t _CanService__handle{
  ...
  ::rosidl_typesupport_fastrtps_cpp::get_message_type_support_handle<custom_msgs::srv::CanService_Request>(),
  ::rosidl_typesupport_fastrtps_cpp::get_message_type_support_handle<custom_msgs::srv::CanService_Response>(),
  ::rosidl_typesupport_fastrtps_cpp::get_message_type_support_handle<custom_msgs::srv::CanService_Event>(),
...
{
  return &custom_msgs::srv::typesupport_fastrtps_cpp::_CanService__handle;
}
...
const rosidl_service_type_support_t *
ROSIDL_TYPESUPPORT_INTERFACE__SERVICE_SYMBOL_NAME(rosidl_typesupport_fastrtps_cpp, custom_msgs, srv, CanService)() {
  return &custom_msgs::srv::typesupport_fastrtps_cpp::_CanService__handle;
}
