\doxysection{Deleter\+Thread Class Reference}
\hypertarget{classDeleterThread}{}\label{classDeleterThread}\index{DeleterThread@{DeleterThread}}
Inheritance diagram for Deleter\+Thread\+:\begin{figure}[H]
\begin{center}
\leavevmode
\includegraphics[height=2.000000cm]{classDeleterThread}
\end{center}
\end{figure}
\doxysubsubsection*{Public Member Functions}
\begin{DoxyCompactItemize}
\item 
\Hypertarget{classDeleterThread_a7d688b9cfb8512aa01ef84df40edf0f3}\label{classDeleterThread_a7d688b9cfb8512aa01ef84df40edf0f3} 
{\bfseries Deleter\+Thread} (\mbox{\hyperlink{classlibcamera_1_1Object}{Object}} \texorpdfstring{$\ast$}{*}obj)
...
\begin{DoxyCompactItemize}
\item 
void \mbox{\hyperlink{classDeleterThread_a1d112d2fe445b4823f645a31a30c4ae3}{run}} ()
...
\Hypertarget{classDeleterThread_a1d112d2fe445b4823f645a31a30c4ae3}\label{classDeleterThread_a1d112d2fe445b4823f645a31a30c4ae3} 
\index{DeleterThread@{DeleterThread}!run@{run}}
\index{run@{run}!DeleterThread@{DeleterThread}}
\doxysubsubsection{\texorpdfstring{run()}{run()}}
{\footnotesize\ttfamily void Deleter\+Thread\+::run (\begin{DoxyParamCaption}{ }\end{DoxyParamCaption})\hspace{0.3cm}{\ttfamily [inline]}, {\ttfamily [protected]}, {\ttfamily [virtual]}}



Main function of the thread. 

When the thread is started with \doxylink{classlibcamera_1_1Thread_a7a41ff49b92b165721070c0199de3df6}{start()}, it calls this function in the context of the new thread. The \doxylink{classDeleterThread_a1d112d2fe445b4823f645a31a30c4ae3}{run()} function can be overridden to perform custom work, either custom initialization and cleanup before and after calling the Thread\+::exec() function, or a custom thread loop altogether. When this function returns the thread execution is stopped, and the \doxylink{classlibcamera_1_1Thread_a7f3bdc2840090cfb00fa8442ce36c3df}{finished} signal is emitted.
