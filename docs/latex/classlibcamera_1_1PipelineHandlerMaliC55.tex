\doxysection{libcamera\+::Pipeline\+Handler\+Mali\+C55 Class Reference}
\hypertarget{classlibcamera_1_1PipelineHandlerMaliC55}{}\label{classlibcamera_1_1PipelineHandlerMaliC55}\index{libcamera::PipelineHandlerMaliC55@{libcamera::PipelineHandlerMaliC55}}
Inheritance diagram for libcamera\+::Pipeline\+Handler\+Mali\+C55\+:\begin{figure}[H]
\begin{center}
\leavevmode
\includegraphics[height=2.818792cm]{classlibcamera_1_1PipelineHandlerMaliC55}
\end{center}
\end{figure}
\doxysubsubsection*{Public Member Functions}
\begin{DoxyCompactItemize}
\item 
\Hypertarget{classlibcamera_1_1PipelineHandlerMaliC55_a11e28f6763d6de6f83dbafbef610d81b}\label{classlibcamera_1_1PipelineHandlerMaliC55_a11e28f6763d6de6f83dbafbef610d81b} 
{\bfseries Pipeline\+Handler\+Mali\+C55} (\mbox{\hyperlink{classlibcamera_1_1CameraManager}{Camera\+Manager}} \texorpdfstring{$\ast$}{*}manager)
\item 
std\+::unique\+\_\+ptr$<$ \mbox{\hyperlink{classlibcamera_1_1CameraConfiguration}{Camera\+Configuration}} $>$ \mbox{\hyperlink{classlibcamera_1_1PipelineHandlerMaliC55_a46eaefd6eeebdb83a507dcea1379612d}{generate\+Configuration}} (\mbox{\hyperlink{classlibcamera_1_1Camera}{Camera}} \texorpdfstring{$\ast$}{*}camera, \mbox{\hyperlink{classlibcamera_1_1Span}{Span}}$<$ const \mbox{\hyperlink{namespacelibcamera_a295d1f5e7828d95c0b0aabc0a8baac03}{Stream\+Role}} $>$ roles) override
\begin{DoxyCompactList}\small\item\em Generate a camera configuration for a specified camera. \end{DoxyCompactList}\item 
int \mbox{\hyperlink{classlibcamera_1_1PipelineHandlerMaliC55_ae50609fcbc4aaa9cae847554afcac8d2}{configure}} (\mbox{\hyperlink{classlibcamera_1_1Camera}{Camera}} \texorpdfstring{$\ast$}{*}camera, \mbox{\hyperlink{classlibcamera_1_1CameraConfiguration}{Camera\+Configuration}} \texorpdfstring{$\ast$}{*}config) override
\begin{DoxyCompactList}\small\item\em Configure a group of streams for capture. \end{DoxyCompactList}\item 
int \mbox{\hyperlink{classlibcamera_1_1PipelineHandlerMaliC55_a7df944f03d0939737e54e5620d6a7429}{export\+Frame\+Buffers}} (\mbox{\hyperlink{classlibcamera_1_1Camera}{Camera}} \texorpdfstring{$\ast$}{*}camera, \mbox{\hyperlink{classlibcamera_1_1Stream}{Stream}} \texorpdfstring{$\ast$}{*}stream, std\+::vector$<$ std\+::unique\+\_\+ptr$<$ \mbox{\hyperlink{classlibcamera_1_1FrameBuffer}{Frame\+Buffer}} $>$ $>$ \texorpdfstring{$\ast$}{*}buffers) override
\begin{DoxyCompactList}\small\item\em Allocate and export buffers for {\itshape stream}. \end{DoxyCompactList}\item 
int \mbox{\hyperlink{classlibcamera_1_1PipelineHandlerMaliC55_abea891b72b51b4e0660adc55c723732e}{start}} (\mbox{\hyperlink{classlibcamera_1_1Camera}{Camera}} \texorpdfstring{$\ast$}{*}camera, const \mbox{\hyperlink{classlibcamera_1_1ControlList}{Control\+List}} \texorpdfstring{$\ast$}{*}controls) override
\begin{DoxyCompactList}\small\item\em Start capturing from a group of streams. \end{DoxyCompactList}\item 
void \mbox{\hyperlink{classlibcamera_1_1PipelineHandlerMaliC55_af721dc63801f8641aebcd66cc02c1464}{stop\+Device}} (\mbox{\hyperlink{classlibcamera_1_1Camera}{Camera}} \texorpdfstring{$\ast$}{*}camera) override
\begin{DoxyCompactList}\small\item\em Stop capturing from all running streams. \end{DoxyCompactList}\item 
int \mbox{\hyperlink{classlibcamera_1_1PipelineHandlerMaliC55_a74b9957d4f8793c6e805320465d330dd}{queue\+Request\+Device}} (\mbox{\hyperlink{classlibcamera_1_1Camera}{Camera}} \texorpdfstring{$\ast$}{*}camera, \mbox{\hyperlink{classlibcamera_1_1Request}{Request}} \texorpdfstring{$\ast$}{*}request) override
\begin{DoxyCompactList}\small\item\em Queue a request to the device. \end{DoxyCompactList}\item 
\Hypertarget{classlibcamera_1_1PipelineHandlerMaliC55_a44cf018eeb8857f26527ad6c0b65ffff}\label{classlibcamera_1_1PipelineHandlerMaliC55_a44cf018eeb8857f26527ad6c0b65ffff} 
void {\bfseries image\+Buffer\+Ready} (\mbox{\hyperlink{classlibcamera_1_1FrameBuffer}{Frame\+Buffer}} \texorpdfstring{$\ast$}{*}buffer)
\item 
bool \mbox{\hyperlink{classlibcamera_1_1PipelineHandlerMaliC55_a3e71e3ac32c5793ba344bd37f9836137}{match}} (\mbox{\hyperlink{classlibcamera_1_1DeviceEnumerator}{Device\+Enumerator}} \texorpdfstring{$\ast$}{*}enumerator) override
...
\Hypertarget{classlibcamera_1_1PipelineHandlerMaliC55_ae50609fcbc4aaa9cae847554afcac8d2}\label{classlibcamera_1_1PipelineHandlerMaliC55_ae50609fcbc4aaa9cae847554afcac8d2} 
\index{libcamera::PipelineHandlerMaliC55@{libcamera::PipelineHandlerMaliC55}!configure@{configure}}
\index{configure@{configure}!libcamera::PipelineHandlerMaliC55@{libcamera::PipelineHandlerMaliC55}}
\doxysubsubsection{\texorpdfstring{configure()}{configure()}}
{\footnotesize\ttfamily int libcamera\+::\+Pipeline\+Handler\+Mali\+C55\+::configure (\begin{DoxyParamCaption}\item[{\mbox{\hyperlink{classlibcamera_1_1Camera}{Camera}} \texorpdfstring{$\ast$}{*}}]{camera,  }\item[{\mbox{\hyperlink{classlibcamera_1_1CameraConfiguration}{Camera\+Configuration}} \texorpdfstring{$\ast$}{*}}]{config }\end{DoxyParamCaption})\hspace{0.3cm}{\ttfamily [override]}, {\ttfamily [virtual]}}
...
\Hypertarget{classlibcamera_1_1PipelineHandlerMaliC55_a7df944f03d0939737e54e5620d6a7429}\label{classlibcamera_1_1PipelineHandlerMaliC55_a7df944f03d0939737e54e5620d6a7429} 
\index{libcamera::PipelineHandlerMaliC55@{libcamera::PipelineHandlerMaliC55}!exportFrameBuffers@{exportFrameBuffers}}
\index{exportFrameBuffers@{exportFrameBuffers}!libcamera::PipelineHandlerMaliC55@{libcamera::PipelineHandlerMaliC55}}
\doxysubsubsection{\texorpdfstring{exportFrameBuffers()}{exportFrameBuffers()}}
{\footnotesize\ttfamily int libcamera\+::\+Pipeline\+Handler\+Mali\+C55\+::export\+Frame\+Buffers (\begin{DoxyParamCaption}\item[{\mbox{\hyperlink{classlibcamera_1_1Camera}{Camera}} \texorpdfstring{$\ast$}{*}}]{camera,  }\item[{\mbox{\hyperlink{classlibcamera_1_1Stream}{Stream}} \texorpdfstring{$\ast$}{*}}]{stream,  }\item[{std\+::vector$<$ std\+::unique\+\_\+ptr$<$ \mbox{\hyperlink{classlibcamera_1_1FrameBuffer}{Frame\+Buffer}} $>$ $>$ \texorpdfstring{$\ast$}{*}}]{buffers }\end{DoxyParamCaption})\hspace{0.3cm}{\ttfamily [override]}, {\ttfamily [virtual]}}
...
\Hypertarget{classlibcamera_1_1PipelineHandlerMaliC55_a46eaefd6eeebdb83a507dcea1379612d}\label{classlibcamera_1_1PipelineHandlerMaliC55_a46eaefd6eeebdb83a507dcea1379612d} 
\index{libcamera::PipelineHandlerMaliC55@{libcamera::PipelineHandlerMaliC55}!generateConfiguration@{generateConfiguration}}
\index{generateConfiguration@{generateConfiguration}!libcamera::PipelineHandlerMaliC55@{libcamera::PipelineHandlerMaliC55}}
\doxysubsubsection{\texorpdfstring{generateConfiguration()}{generateConfiguration()}}
{\footnotesize\ttfamily std\+::unique\+\_\+ptr$<$ \mbox{\hyperlink{classlibcamera_1_1CameraConfiguration}{Camera\+Configuration}} $>$ libcamera\+::\+Pipeline\+Handler\+Mali\+C55\+::generate\+Configuration (\begin{DoxyParamCaption}\item[{\mbox{\hyperlink{classlibcamera_1_1Camera}{Camera}} \texorpdfstring{$\ast$}{*}}]{camera,  }\item[{\mbox{\hyperlink{classlibcamera_1_1Span}{Span}}$<$ const \mbox{\hyperlink{namespacelibcamera_a295d1f5e7828d95c0b0aabc0a8baac03}{Stream\+Role}} $>$}]{roles }\end{DoxyParamCaption})\hspace{0.3cm}{\ttfamily [override]}, {\ttfamily [virtual]}}
...
The intended companion to this is {\itshape \doxylink{classlibcamera_1_1PipelineHandlerMaliC55_ae50609fcbc4aaa9cae847554afcac8d2}{configure()}} which can be used to change the group of streams parameters.
...
\Hypertarget{classlibcamera_1_1PipelineHandlerMaliC55_a3e71e3ac32c5793ba344bd37f9836137}\label{classlibcamera_1_1PipelineHandlerMaliC55_a3e71e3ac32c5793ba344bd37f9836137} 
\index{libcamera::PipelineHandlerMaliC55@{libcamera::PipelineHandlerMaliC55}!match@{match}}
\index{match@{match}!libcamera::PipelineHandlerMaliC55@{libcamera::PipelineHandlerMaliC55}}
\doxysubsubsection{\texorpdfstring{match()}{match()}}
{\footnotesize\ttfamily bool libcamera\+::\+Pipeline\+Handler\+Mali\+C55\+::match (\begin{DoxyParamCaption}\item[{\mbox{\hyperlink{classlibcamera_1_1DeviceEnumerator}{Device\+Enumerator}} \texorpdfstring{$\ast$}{*}}]{enumerator }\end{DoxyParamCaption})\hspace{0.3cm}{\ttfamily [override]}, {\ttfamily [virtual]}}
...
\Hypertarget{classlibcamera_1_1PipelineHandlerMaliC55_a74b9957d4f8793c6e805320465d330dd}\label{classlibcamera_1_1PipelineHandlerMaliC55_a74b9957d4f8793c6e805320465d330dd} 
\index{libcamera::PipelineHandlerMaliC55@{libcamera::PipelineHandlerMaliC55}!queueRequestDevice@{queueRequestDevice}}
\index{queueRequestDevice@{queueRequestDevice}!libcamera::PipelineHandlerMaliC55@{libcamera::PipelineHandlerMaliC55}}
\doxysubsubsection{\texorpdfstring{queueRequestDevice()}{queueRequestDevice()}}
{\footnotesize\ttfamily int libcamera\+::\+Pipeline\+Handler\+Mali\+C55\+::queue\+Request\+Device (\begin{DoxyParamCaption}\item[{\mbox{\hyperlink{classlibcamera_1_1Camera}{Camera}} \texorpdfstring{$\ast$}{*}}]{camera,  }\item[{\mbox{\hyperlink{classlibcamera_1_1Request}{Request}} \texorpdfstring{$\ast$}{*}}]{request }\end{DoxyParamCaption})\hspace{0.3cm}{\ttfamily [override]}, {\ttfamily [virtual]}}
...
\Hypertarget{classlibcamera_1_1PipelineHandlerMaliC55_abea891b72b51b4e0660adc55c723732e}\label{classlibcamera_1_1PipelineHandlerMaliC55_abea891b72b51b4e0660adc55c723732e} 
\index{libcamera::PipelineHandlerMaliC55@{libcamera::PipelineHandlerMaliC55}!start@{start}}
\index{start@{start}!libcamera::PipelineHandlerMaliC55@{libcamera::PipelineHandlerMaliC55}}
\doxysubsubsection{\texorpdfstring{start()}{start()}}
{\footnotesize\ttfamily int libcamera\+::\+Pipeline\+Handler\+Mali\+C55\+::start (\begin{DoxyParamCaption}\item[{\mbox{\hyperlink{classlibcamera_1_1Camera}{Camera}} \texorpdfstring{$\ast$}{*}}]{camera,  }\item[{const \mbox{\hyperlink{classlibcamera_1_1ControlList}{Control\+List}} \texorpdfstring{$\ast$}{*}}]{controls }\end{DoxyParamCaption})\hspace{0.3cm}{\ttfamily [override]}, {\ttfamily [virtual]}}
...
\Hypertarget{classlibcamera_1_1PipelineHandlerMaliC55_af721dc63801f8641aebcd66cc02c1464}\label{classlibcamera_1_1PipelineHandlerMaliC55_af721dc63801f8641aebcd66cc02c1464} 
\index{libcamera::PipelineHandlerMaliC55@{libcamera::PipelineHandlerMaliC55}!stopDevice@{stopDevice}}
\index{stopDevice@{stopDevice}!libcamera::PipelineHandlerMaliC55@{libcamera::PipelineHandlerMaliC55}}
\doxysubsubsection{\texorpdfstring{stopDevice()}{stopDevice()}}
{\footnotesize\ttfamily void libcamera\+::\+Pipeline\+Handler\+Mali\+C55\+::stop\+Device (\begin{DoxyParamCaption}\item[{\mbox{\hyperlink{classlibcamera_1_1Camera}{Camera}} \texorpdfstring{$\ast$}{*}}]{camera }\end{DoxyParamCaption})\hspace{0.3cm}{\ttfamily [override]}, {\ttfamily [virtual]}}
