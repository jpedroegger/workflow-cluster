\doxysection{libcamera\+::Pipeline\+Handler\+IPU3 Class Reference}
\hypertarget{classlibcamera_1_1PipelineHandlerIPU3}{}\label{classlibcamera_1_1PipelineHandlerIPU3}\index{libcamera::PipelineHandlerIPU3@{libcamera::PipelineHandlerIPU3}}
Inheritance diagram for libcamera\+::Pipeline\+Handler\+IPU3\+:\begin{figure}[H]
\begin{center}
\leavevmode
\includegraphics[height=2.818792cm]{classlibcamera_1_1PipelineHandlerIPU3}
\end{center}
\end{figure}
\doxysubsubsection*{Public Types}
\begin{DoxyCompactItemize}
\item 
\Hypertarget{classlibcamera_1_1PipelineHandlerIPU3_a617c18e153ed96970e1c373f76f833ca}\label{classlibcamera_1_1PipelineHandlerIPU3_a617c18e153ed96970e1c373f76f833ca} 
enum {\bfseries IPU3\+Pipe\+Modes} \{ {\bfseries IPU3\+Pipe\+Mode\+Video} = 0
, {\bfseries IPU3\+Pipe\+Mode\+Still\+Capture} = 1
 \}
\end{DoxyCompactItemize}
\doxysubsubsection*{Public Member Functions}
\begin{DoxyCompactItemize}
\item 
\Hypertarget{classlibcamera_1_1PipelineHandlerIPU3_abd6a0af828a580633d20c87c06664d28}\label{classlibcamera_1_1PipelineHandlerIPU3_abd6a0af828a580633d20c87c06664d28} 
{\bfseries Pipeline\+Handler\+IPU3} (\mbox{\hyperlink{classlibcamera_1_1CameraManager}{Camera\+Manager}} \texorpdfstring{$\ast$}{*}manager)
\item 
std\+::unique\+\_\+ptr$<$ \mbox{\hyperlink{classlibcamera_1_1CameraConfiguration}{Camera\+Configuration}} $>$ \mbox{\hyperlink{classlibcamera_1_1PipelineHandlerIPU3_a8185abf3c24e1055fe97f91a99780a84}{generate\+Configuration}} (\mbox{\hyperlink{classlibcamera_1_1Camera}{Camera}} \texorpdfstring{$\ast$}{*}camera, \mbox{\hyperlink{classlibcamera_1_1Span}{Span}}$<$ const \mbox{\hyperlink{namespacelibcamera_a295d1f5e7828d95c0b0aabc0a8baac03}{Stream\+Role}} $>$ roles) override
\begin{DoxyCompactList}\small\item\em Generate a camera configuration for a specified camera. \end{DoxyCompactList}\item 
int \mbox{\hyperlink{classlibcamera_1_1PipelineHandlerIPU3_ab11fd7a10d30011ab2a49d132e8d41cb}{configure}} (\mbox{\hyperlink{classlibcamera_1_1Camera}{Camera}} \texorpdfstring{$\ast$}{*}camera, \mbox{\hyperlink{classlibcamera_1_1CameraConfiguration}{Camera\+Configuration}} \texorpdfstring{$\ast$}{*}config) override
\begin{DoxyCompactList}\small\item\em Configure a group of streams for capture. \end{DoxyCompactList}\item 
int \mbox{\hyperlink{classlibcamera_1_1PipelineHandlerIPU3_a11908ea0f4f00ded85c8aa0234ba7e4f}{export\+Frame\+Buffers}} (\mbox{\hyperlink{classlibcamera_1_1Camera}{Camera}} \texorpdfstring{$\ast$}{*}camera, \mbox{\hyperlink{classlibcamera_1_1Stream}{Stream}} \texorpdfstring{$\ast$}{*}stream, std\+::vector$<$ std\+::unique\+\_\+ptr$<$ \mbox{\hyperlink{classlibcamera_1_1FrameBuffer}{Frame\+Buffer}} $>$ $>$ \texorpdfstring{$\ast$}{*}buffers) override
\begin{DoxyCompactList}\small\item\em Allocate and export buffers for {\itshape stream}. \end{DoxyCompactList}\item 
int \mbox{\hyperlink{classlibcamera_1_1PipelineHandlerIPU3_a62c00d70d2ecbdc9971ea108da4c9b4f}{start}} (\mbox{\hyperlink{classlibcamera_1_1Camera}{Camera}} \texorpdfstring{$\ast$}{*}camera, const \mbox{\hyperlink{classlibcamera_1_1ControlList}{Control\+List}} \texorpdfstring{$\ast$}{*}controls) override
\begin{DoxyCompactList}\small\item\em Start capturing from a group of streams. \end{DoxyCompactList}\item 
void \mbox{\hyperlink{classlibcamera_1_1PipelineHandlerIPU3_ab771dead5e5fc71afef240eb3a650cdf}{stop\+Device}} (\mbox{\hyperlink{classlibcamera_1_1Camera}{Camera}} \texorpdfstring{$\ast$}{*}camera) override
\begin{DoxyCompactList}\small\item\em Stop capturing from all running streams. \end{DoxyCompactList}\item 
int \mbox{\hyperlink{classlibcamera_1_1PipelineHandlerIPU3_a0caba989f5d2cba0b1ff17b5fc4d04e7}{queue\+Request\+Device}} (\mbox{\hyperlink{classlibcamera_1_1Camera}{Camera}} \texorpdfstring{$\ast$}{*}camera, \mbox{\hyperlink{classlibcamera_1_1Request}{Request}} \texorpdfstring{$\ast$}{*}request) override
\begin{DoxyCompactList}\small\item\em Queue a request to the device. \end{DoxyCompactList}\item 
bool \mbox{\hyperlink{classlibcamera_1_1PipelineHandlerIPU3_a96b243bafde1296c6ca636ef3338ad4d}{match}} (\mbox{\hyperlink{classlibcamera_1_1DeviceEnumerator}{Device\+Enumerator}} \texorpdfstring{$\ast$}{*}enumerator) override
...
\begin{DoxyCompactItemize}
\item 
\Hypertarget{classlibcamera_1_1PipelineHandlerIPU3_ab9cd2be2c42dcf35f6a9a76f18440b52}\label{classlibcamera_1_1PipelineHandlerIPU3_ab9cd2be2c42dcf35f6a9a76f18440b52} 
static constexpr unsigned int {\bfseries V4\+L2\+\_\+\+CID\+\_\+\+IPU3\+\_\+\+PIPE\+\_\+\+MODE} = 0x009819c1
\item 
\Hypertarget{classlibcamera_1_1PipelineHandlerIPU3_a7908deb54bdc829a70277c7d398f66dd}\label{classlibcamera_1_1PipelineHandlerIPU3_a7908deb54bdc829a70277c7d398f66dd} 
static constexpr \mbox{\hyperlink{classlibcamera_1_1Size}{Size}} {\bfseries k\+Viewfinder\+Size} \{ 1280, 720 \}
\end{DoxyCompactItemize}
...
\Hypertarget{classlibcamera_1_1PipelineHandlerIPU3_ab11fd7a10d30011ab2a49d132e8d41cb}\label{classlibcamera_1_1PipelineHandlerIPU3_ab11fd7a10d30011ab2a49d132e8d41cb} 
\index{libcamera::PipelineHandlerIPU3@{libcamera::PipelineHandlerIPU3}!configure@{configure}}
\index{configure@{configure}!libcamera::PipelineHandlerIPU3@{libcamera::PipelineHandlerIPU3}}
\doxysubsubsection{\texorpdfstring{configure()}{configure()}}
{\footnotesize\ttfamily int libcamera\+::\+Pipeline\+Handler\+IPU3\+::configure (\begin{DoxyParamCaption}\item[{\mbox{\hyperlink{classlibcamera_1_1Camera}{Camera}} \texorpdfstring{$\ast$}{*}}]{camera,  }\item[{\mbox{\hyperlink{classlibcamera_1_1CameraConfiguration}{Camera\+Configuration}} \texorpdfstring{$\ast$}{*}}]{config }\end{DoxyParamCaption})\hspace{0.3cm}{\ttfamily [override]}, {\ttfamily [virtual]}}
...
\Hypertarget{classlibcamera_1_1PipelineHandlerIPU3_a11908ea0f4f00ded85c8aa0234ba7e4f}\label{classlibcamera_1_1PipelineHandlerIPU3_a11908ea0f4f00ded85c8aa0234ba7e4f} 
\index{libcamera::PipelineHandlerIPU3@{libcamera::PipelineHandlerIPU3}!exportFrameBuffers@{exportFrameBuffers}}
\index{exportFrameBuffers@{exportFrameBuffers}!libcamera::PipelineHandlerIPU3@{libcamera::PipelineHandlerIPU3}}
\doxysubsubsection{\texorpdfstring{exportFrameBuffers()}{exportFrameBuffers()}}
{\footnotesize\ttfamily int libcamera\+::\+Pipeline\+Handler\+IPU3\+::export\+Frame\+Buffers (\begin{DoxyParamCaption}\item[{\mbox{\hyperlink{classlibcamera_1_1Camera}{Camera}} \texorpdfstring{$\ast$}{*}}]{camera,  }\item[{\mbox{\hyperlink{classlibcamera_1_1Stream}{Stream}} \texorpdfstring{$\ast$}{*}}]{stream,  }\item[{std\+::vector$<$ std\+::unique\+\_\+ptr$<$ \mbox{\hyperlink{classlibcamera_1_1FrameBuffer}{Frame\+Buffer}} $>$ $>$ \texorpdfstring{$\ast$}{*}}]{buffers }\end{DoxyParamCaption})\hspace{0.3cm}{\ttfamily [override]}, {\ttfamily [virtual]}}
...
\Hypertarget{classlibcamera_1_1PipelineHandlerIPU3_a8185abf3c24e1055fe97f91a99780a84}\label{classlibcamera_1_1PipelineHandlerIPU3_a8185abf3c24e1055fe97f91a99780a84} 
\index{libcamera::PipelineHandlerIPU3@{libcamera::PipelineHandlerIPU3}!generateConfiguration@{generateConfiguration}}
\index{generateConfiguration@{generateConfiguration}!libcamera::PipelineHandlerIPU3@{libcamera::PipelineHandlerIPU3}}
\doxysubsubsection{\texorpdfstring{generateConfiguration()}{generateConfiguration()}}
{\footnotesize\ttfamily std\+::unique\+\_\+ptr$<$ \mbox{\hyperlink{classlibcamera_1_1CameraConfiguration}{Camera\+Configuration}} $>$ libcamera\+::\+Pipeline\+Handler\+IPU3\+::generate\+Configuration (\begin{DoxyParamCaption}\item[{\mbox{\hyperlink{classlibcamera_1_1Camera}{Camera}} \texorpdfstring{$\ast$}{*}}]{camera,  }\item[{\mbox{\hyperlink{classlibcamera_1_1Span}{Span}}$<$ const \mbox{\hyperlink{namespacelibcamera_a295d1f5e7828d95c0b0aabc0a8baac03}{Stream\+Role}} $>$}]{roles }\end{DoxyParamCaption})\hspace{0.3cm}{\ttfamily [override]}, {\ttfamily [virtual]}}
...
The intended companion to this is {\itshape \doxylink{classlibcamera_1_1PipelineHandlerIPU3_ab11fd7a10d30011ab2a49d132e8d41cb}{configure()}} which can be used to change the group of streams parameters.
...
\Hypertarget{classlibcamera_1_1PipelineHandlerIPU3_a96b243bafde1296c6ca636ef3338ad4d}\label{classlibcamera_1_1PipelineHandlerIPU3_a96b243bafde1296c6ca636ef3338ad4d} 
\index{libcamera::PipelineHandlerIPU3@{libcamera::PipelineHandlerIPU3}!match@{match}}
\index{match@{match}!libcamera::PipelineHandlerIPU3@{libcamera::PipelineHandlerIPU3}}
\doxysubsubsection{\texorpdfstring{match()}{match()}}
{\footnotesize\ttfamily bool libcamera\+::\+Pipeline\+Handler\+IPU3\+::match (\begin{DoxyParamCaption}\item[{\mbox{\hyperlink{classlibcamera_1_1DeviceEnumerator}{Device\+Enumerator}} \texorpdfstring{$\ast$}{*}}]{enumerator }\end{DoxyParamCaption})\hspace{0.3cm}{\ttfamily [override]}, {\ttfamily [virtual]}}
...
\Hypertarget{classlibcamera_1_1PipelineHandlerIPU3_a0caba989f5d2cba0b1ff17b5fc4d04e7}\label{classlibcamera_1_1PipelineHandlerIPU3_a0caba989f5d2cba0b1ff17b5fc4d04e7} 
\index{libcamera::PipelineHandlerIPU3@{libcamera::PipelineHandlerIPU3}!queueRequestDevice@{queueRequestDevice}}
\index{queueRequestDevice@{queueRequestDevice}!libcamera::PipelineHandlerIPU3@{libcamera::PipelineHandlerIPU3}}
\doxysubsubsection{\texorpdfstring{queueRequestDevice()}{queueRequestDevice()}}
{\footnotesize\ttfamily int libcamera\+::\+Pipeline\+Handler\+IPU3\+::queue\+Request\+Device (\begin{DoxyParamCaption}\item[{\mbox{\hyperlink{classlibcamera_1_1Camera}{Camera}} \texorpdfstring{$\ast$}{*}}]{camera,  }\item[{\mbox{\hyperlink{classlibcamera_1_1Request}{Request}} \texorpdfstring{$\ast$}{*}}]{request }\end{DoxyParamCaption})\hspace{0.3cm}{\ttfamily [override]}, {\ttfamily [virtual]}}
...
\Hypertarget{classlibcamera_1_1PipelineHandlerIPU3_a62c00d70d2ecbdc9971ea108da4c9b4f}\label{classlibcamera_1_1PipelineHandlerIPU3_a62c00d70d2ecbdc9971ea108da4c9b4f} 
\index{libcamera::PipelineHandlerIPU3@{libcamera::PipelineHandlerIPU3}!start@{start}}
\index{start@{start}!libcamera::PipelineHandlerIPU3@{libcamera::PipelineHandlerIPU3}}
\doxysubsubsection{\texorpdfstring{start()}{start()}}
{\footnotesize\ttfamily int libcamera\+::\+Pipeline\+Handler\+IPU3\+::start (\begin{DoxyParamCaption}\item[{\mbox{\hyperlink{classlibcamera_1_1Camera}{Camera}} \texorpdfstring{$\ast$}{*}}]{camera,  }\item[{const \mbox{\hyperlink{classlibcamera_1_1ControlList}{Control\+List}} \texorpdfstring{$\ast$}{*}}]{controls }\end{DoxyParamCaption})\hspace{0.3cm}{\ttfamily [override]}, {\ttfamily [virtual]}}
...
\Hypertarget{classlibcamera_1_1PipelineHandlerIPU3_ab771dead5e5fc71afef240eb3a650cdf}\label{classlibcamera_1_1PipelineHandlerIPU3_ab771dead5e5fc71afef240eb3a650cdf} 
\index{libcamera::PipelineHandlerIPU3@{libcamera::PipelineHandlerIPU3}!stopDevice@{stopDevice}}
\index{stopDevice@{stopDevice}!libcamera::PipelineHandlerIPU3@{libcamera::PipelineHandlerIPU3}}
\doxysubsubsection{\texorpdfstring{stopDevice()}{stopDevice()}}
{\footnotesize\ttfamily void libcamera\+::\+Pipeline\+Handler\+IPU3\+::stop\+Device (\begin{DoxyParamCaption}\item[{\mbox{\hyperlink{classlibcamera_1_1Camera}{Camera}} \texorpdfstring{$\ast$}{*}}]{camera }\end{DoxyParamCaption})\hspace{0.3cm}{\ttfamily [override]}, {\ttfamily [virtual]}}
