\doxysection{Delay\+Thread Class Reference}
\hypertarget{classDelayThread}{}\label{classDelayThread}\index{DelayThread@{DelayThread}}
Inheritance diagram for Delay\+Thread\+:\begin{figure}[H]
\begin{center}
\leavevmode
\includegraphics[height=2.000000cm]{classDelayThread}
\end{center}
\end{figure}
\doxysubsubsection*{Public Member Functions}
\begin{DoxyCompactItemize}
\item 
\Hypertarget{classDelayThread_ad66e0f02f100dbd77df7a6ed9adca816}\label{classDelayThread_ad66e0f02f100dbd77df7a6ed9adca816} 
{\bfseries Delay\+Thread} (chrono\+::steady\+\_\+clock\+::duration duration)
...
\begin{DoxyCompactItemize}
\item 
void \mbox{\hyperlink{classDelayThread_ac07540dd0f7d3ee6b3de2ffbb9e08fb4}{run}} ()
...
\Hypertarget{classDelayThread_ac07540dd0f7d3ee6b3de2ffbb9e08fb4}\label{classDelayThread_ac07540dd0f7d3ee6b3de2ffbb9e08fb4} 
\index{DelayThread@{DelayThread}!run@{run}}
\index{run@{run}!DelayThread@{DelayThread}}
\doxysubsubsection{\texorpdfstring{run()}{run()}}
{\footnotesize\ttfamily void Delay\+Thread\+::run (\begin{DoxyParamCaption}{ }\end{DoxyParamCaption})\hspace{0.3cm}{\ttfamily [inline]}, {\ttfamily [protected]}, {\ttfamily [virtual]}}



Main function of the thread. 

When the thread is started with \doxylink{classlibcamera_1_1Thread_a7a41ff49b92b165721070c0199de3df6}{start()}, it calls this function in the context of the new thread. The \doxylink{classDelayThread_ac07540dd0f7d3ee6b3de2ffbb9e08fb4}{run()} function can be overridden to perform custom work, either custom initialization and cleanup before and after calling the Thread\+::exec() function, or a custom thread loop altogether. When this function returns the thread execution is stopped, and the \doxylink{classlibcamera_1_1Thread_a7f3bdc2840090cfb00fa8442ce36c3df}{finished} signal is emitted.
