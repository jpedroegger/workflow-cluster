\doxysection{libcamera\+::Simple\+Pipeline\+Handler Class Reference}
\hypertarget{classlibcamera_1_1SimplePipelineHandler}{}\label{classlibcamera_1_1SimplePipelineHandler}\index{libcamera::SimplePipelineHandler@{libcamera::SimplePipelineHandler}}
Inheritance diagram for libcamera\+::Simple\+Pipeline\+Handler\+:\begin{figure}[H]
\begin{center}
\leavevmode
\includegraphics[height=2.818792cm]{classlibcamera_1_1SimplePipelineHandler}
\end{center}
\end{figure}
\doxysubsubsection*{Public Member Functions}
\begin{DoxyCompactItemize}
\item 
\Hypertarget{classlibcamera_1_1SimplePipelineHandler_ac11dd3340b29afc3af0fd45176018062}\label{classlibcamera_1_1SimplePipelineHandler_ac11dd3340b29afc3af0fd45176018062} 
{\bfseries Simple\+Pipeline\+Handler} (\mbox{\hyperlink{classlibcamera_1_1CameraManager}{Camera\+Manager}} \texorpdfstring{$\ast$}{*}manager)
\item 
std\+::unique\+\_\+ptr$<$ \mbox{\hyperlink{classlibcamera_1_1CameraConfiguration}{Camera\+Configuration}} $>$ \mbox{\hyperlink{classlibcamera_1_1SimplePipelineHandler_abe8401bb370182ebb17bbc66fae8a235}{generate\+Configuration}} (\mbox{\hyperlink{classlibcamera_1_1Camera}{Camera}} \texorpdfstring{$\ast$}{*}camera, \mbox{\hyperlink{classlibcamera_1_1Span}{Span}}$<$ const \mbox{\hyperlink{namespacelibcamera_a295d1f5e7828d95c0b0aabc0a8baac03}{Stream\+Role}} $>$ roles) override
\begin{DoxyCompactList}\small\item\em Generate a camera configuration for a specified camera. \end{DoxyCompactList}\item 
int \mbox{\hyperlink{classlibcamera_1_1SimplePipelineHandler_ac056f28e2655cc5763f8d247792265c0}{configure}} (\mbox{\hyperlink{classlibcamera_1_1Camera}{Camera}} \texorpdfstring{$\ast$}{*}camera, \mbox{\hyperlink{classlibcamera_1_1CameraConfiguration}{Camera\+Configuration}} \texorpdfstring{$\ast$}{*}config) override
\begin{DoxyCompactList}\small\item\em Configure a group of streams for capture. \end{DoxyCompactList}\item 
int \mbox{\hyperlink{classlibcamera_1_1SimplePipelineHandler_ad18662e93e757f9decd9643f4d296f64}{export\+Frame\+Buffers}} (\mbox{\hyperlink{classlibcamera_1_1Camera}{Camera}} \texorpdfstring{$\ast$}{*}camera, \mbox{\hyperlink{classlibcamera_1_1Stream}{Stream}} \texorpdfstring{$\ast$}{*}stream, std\+::vector$<$ std\+::unique\+\_\+ptr$<$ \mbox{\hyperlink{classlibcamera_1_1FrameBuffer}{Frame\+Buffer}} $>$ $>$ \texorpdfstring{$\ast$}{*}buffers) override
\begin{DoxyCompactList}\small\item\em Allocate and export buffers for {\itshape stream}. \end{DoxyCompactList}\item 
int \mbox{\hyperlink{classlibcamera_1_1SimplePipelineHandler_a38367b89eb92e92c69958a569cc8f314}{start}} (\mbox{\hyperlink{classlibcamera_1_1Camera}{Camera}} \texorpdfstring{$\ast$}{*}camera, const \mbox{\hyperlink{classlibcamera_1_1ControlList}{Control\+List}} \texorpdfstring{$\ast$}{*}controls) override
\begin{DoxyCompactList}\small\item\em Start capturing from a group of streams. \end{DoxyCompactList}\item 
void \mbox{\hyperlink{classlibcamera_1_1SimplePipelineHandler_ac4834498be993f837eb2be3592ec92a0}{stop\+Device}} (\mbox{\hyperlink{classlibcamera_1_1Camera}{Camera}} \texorpdfstring{$\ast$}{*}camera) override
\begin{DoxyCompactList}\small\item\em Stop capturing from all running streams. \end{DoxyCompactList}\item 
bool \mbox{\hyperlink{classlibcamera_1_1SimplePipelineHandler_a4db3b2ee338bcf21930b3f2a65d1c330}{match}} (\mbox{\hyperlink{classlibcamera_1_1DeviceEnumerator}{Device\+Enumerator}} \texorpdfstring{$\ast$}{*}enumerator) override
\begin{DoxyCompactList}\small\item\em Match media devices and create camera instances. \end{DoxyCompactList}\item 
\Hypertarget{classlibcamera_1_1SimplePipelineHandler_aa25729d1885be2a9b5b3b8b9a9ed0d3d}\label{classlibcamera_1_1SimplePipelineHandler_aa25729d1885be2a9b5b3b8b9a9ed0d3d} 
\mbox{\hyperlink{classlibcamera_1_1V4L2VideoDevice}{V4\+L2\+Video\+Device}} \texorpdfstring{$\ast$}{*} {\bfseries video} (const \mbox{\hyperlink{classlibcamera_1_1MediaEntity}{Media\+Entity}} \texorpdfstring{$\ast$}{*}entity)
\item 
\Hypertarget{classlibcamera_1_1SimplePipelineHandler_aaa91a73fc24682db4ca9ce57ba7dcbab}\label{classlibcamera_1_1SimplePipelineHandler_aaa91a73fc24682db4ca9ce57ba7dcbab} 
\mbox{\hyperlink{classlibcamera_1_1V4L2Subdevice}{V4\+L2\+Subdevice}} \texorpdfstring{$\ast$}{*} {\bfseries subdev} (const \mbox{\hyperlink{classlibcamera_1_1MediaEntity}{Media\+Entity}} \texorpdfstring{$\ast$}{*}entity)
\item 
\Hypertarget{classlibcamera_1_1SimplePipelineHandler_a14b968bef2f0519c6f7ac419f4d36dd3}\label{classlibcamera_1_1SimplePipelineHandler_a14b968bef2f0519c6f7ac419f4d36dd3} 
\mbox{\hyperlink{classlibcamera_1_1MediaDevice}{Media\+Device}} \texorpdfstring{$\ast$}{*} {\bfseries converter} ()
\item 
\Hypertarget{classlibcamera_1_1SimplePipelineHandler_aaa6d3074be3b76c9e06ee4ef984522a0}\label{classlibcamera_1_1SimplePipelineHandler_aaa6d3074be3b76c9e06ee4ef984522a0} 
bool {\bfseries sw\+Isp\+Enabled} () const
...
\begin{DoxyCompactItemize}
\item 
int \mbox{\hyperlink{classlibcamera_1_1SimplePipelineHandler_a519e6c1812a47c44c14cef6e8dc779e1}{queue\+Request\+Device}} (\mbox{\hyperlink{classlibcamera_1_1Camera}{Camera}} \texorpdfstring{$\ast$}{*}camera, \mbox{\hyperlink{classlibcamera_1_1Request}{Request}} \texorpdfstring{$\ast$}{*}request) override
...
\Hypertarget{classlibcamera_1_1SimplePipelineHandler_ac056f28e2655cc5763f8d247792265c0}\label{classlibcamera_1_1SimplePipelineHandler_ac056f28e2655cc5763f8d247792265c0} 
\index{libcamera::SimplePipelineHandler@{libcamera::SimplePipelineHandler}!configure@{configure}}
\index{configure@{configure}!libcamera::SimplePipelineHandler@{libcamera::SimplePipelineHandler}}
\doxysubsubsection{\texorpdfstring{configure()}{configure()}}
{\footnotesize\ttfamily int libcamera\+::\+Simple\+Pipeline\+Handler\+::configure (\begin{DoxyParamCaption}\item[{\mbox{\hyperlink{classlibcamera_1_1Camera}{Camera}} \texorpdfstring{$\ast$}{*}}]{camera,  }\item[{\mbox{\hyperlink{classlibcamera_1_1CameraConfiguration}{Camera\+Configuration}} \texorpdfstring{$\ast$}{*}}]{config }\end{DoxyParamCaption})\hspace{0.3cm}{\ttfamily [override]}, {\ttfamily [virtual]}}
...
\Hypertarget{classlibcamera_1_1SimplePipelineHandler_ad18662e93e757f9decd9643f4d296f64}\label{classlibcamera_1_1SimplePipelineHandler_ad18662e93e757f9decd9643f4d296f64} 
\index{libcamera::SimplePipelineHandler@{libcamera::SimplePipelineHandler}!exportFrameBuffers@{exportFrameBuffers}}
\index{exportFrameBuffers@{exportFrameBuffers}!libcamera::SimplePipelineHandler@{libcamera::SimplePipelineHandler}}
\doxysubsubsection{\texorpdfstring{exportFrameBuffers()}{exportFrameBuffers()}}
{\footnotesize\ttfamily int libcamera\+::\+Simple\+Pipeline\+Handler\+::export\+Frame\+Buffers (\begin{DoxyParamCaption}\item[{\mbox{\hyperlink{classlibcamera_1_1Camera}{Camera}} \texorpdfstring{$\ast$}{*}}]{camera,  }\item[{\mbox{\hyperlink{classlibcamera_1_1Stream}{Stream}} \texorpdfstring{$\ast$}{*}}]{stream,  }\item[{std\+::vector$<$ std\+::unique\+\_\+ptr$<$ \mbox{\hyperlink{classlibcamera_1_1FrameBuffer}{Frame\+Buffer}} $>$ $>$ \texorpdfstring{$\ast$}{*}}]{buffers }\end{DoxyParamCaption})\hspace{0.3cm}{\ttfamily [override]}, {\ttfamily [virtual]}}
...
\Hypertarget{classlibcamera_1_1SimplePipelineHandler_abe8401bb370182ebb17bbc66fae8a235}\label{classlibcamera_1_1SimplePipelineHandler_abe8401bb370182ebb17bbc66fae8a235} 
\index{libcamera::SimplePipelineHandler@{libcamera::SimplePipelineHandler}!generateConfiguration@{generateConfiguration}}
\index{generateConfiguration@{generateConfiguration}!libcamera::SimplePipelineHandler@{libcamera::SimplePipelineHandler}}
\doxysubsubsection{\texorpdfstring{generateConfiguration()}{generateConfiguration()}}
{\footnotesize\ttfamily std\+::unique\+\_\+ptr$<$ \mbox{\hyperlink{classlibcamera_1_1CameraConfiguration}{Camera\+Configuration}} $>$ libcamera\+::\+Simple\+Pipeline\+Handler\+::generate\+Configuration (\begin{DoxyParamCaption}\item[{\mbox{\hyperlink{classlibcamera_1_1Camera}{Camera}} \texorpdfstring{$\ast$}{*}}]{camera,  }\item[{\mbox{\hyperlink{classlibcamera_1_1Span}{Span}}$<$ const \mbox{\hyperlink{namespacelibcamera_a295d1f5e7828d95c0b0aabc0a8baac03}{Stream\+Role}} $>$}]{roles }\end{DoxyParamCaption})\hspace{0.3cm}{\ttfamily [override]}, {\ttfamily [virtual]}}
...
The intended companion to this is {\itshape \doxylink{classlibcamera_1_1SimplePipelineHandler_ac056f28e2655cc5763f8d247792265c0}{configure()}} which can be used to change the group of streams parameters.
...
\Hypertarget{classlibcamera_1_1SimplePipelineHandler_a4db3b2ee338bcf21930b3f2a65d1c330}\label{classlibcamera_1_1SimplePipelineHandler_a4db3b2ee338bcf21930b3f2a65d1c330} 
\index{libcamera::SimplePipelineHandler@{libcamera::SimplePipelineHandler}!match@{match}}
\index{match@{match}!libcamera::SimplePipelineHandler@{libcamera::SimplePipelineHandler}}
\doxysubsubsection{\texorpdfstring{match()}{match()}}
{\footnotesize\ttfamily bool libcamera\+::\+Simple\+Pipeline\+Handler\+::match (\begin{DoxyParamCaption}\item[{\mbox{\hyperlink{classlibcamera_1_1DeviceEnumerator}{Device\+Enumerator}} \texorpdfstring{$\ast$}{*}}]{enumerator }\end{DoxyParamCaption})\hspace{0.3cm}{\ttfamily [override]}, {\ttfamily [virtual]}}
...
\Hypertarget{classlibcamera_1_1SimplePipelineHandler_a519e6c1812a47c44c14cef6e8dc779e1}\label{classlibcamera_1_1SimplePipelineHandler_a519e6c1812a47c44c14cef6e8dc779e1} 
\index{libcamera::SimplePipelineHandler@{libcamera::SimplePipelineHandler}!queueRequestDevice@{queueRequestDevice}}
\index{queueRequestDevice@{queueRequestDevice}!libcamera::SimplePipelineHandler@{libcamera::SimplePipelineHandler}}
\doxysubsubsection{\texorpdfstring{queueRequestDevice()}{queueRequestDevice()}}
{\footnotesize\ttfamily int libcamera\+::\+Simple\+Pipeline\+Handler\+::queue\+Request\+Device (\begin{DoxyParamCaption}\item[{\mbox{\hyperlink{classlibcamera_1_1Camera}{Camera}} \texorpdfstring{$\ast$}{*}}]{camera,  }\item[{\mbox{\hyperlink{classlibcamera_1_1Request}{Request}} \texorpdfstring{$\ast$}{*}}]{request }\end{DoxyParamCaption})\hspace{0.3cm}{\ttfamily [override]}, {\ttfamily [protected]}, {\ttfamily [virtual]}}
...
\Hypertarget{classlibcamera_1_1SimplePipelineHandler_a38367b89eb92e92c69958a569cc8f314}\label{classlibcamera_1_1SimplePipelineHandler_a38367b89eb92e92c69958a569cc8f314} 
\index{libcamera::SimplePipelineHandler@{libcamera::SimplePipelineHandler}!start@{start}}
\index{start@{start}!libcamera::SimplePipelineHandler@{libcamera::SimplePipelineHandler}}
\doxysubsubsection{\texorpdfstring{start()}{start()}}
{\footnotesize\ttfamily int libcamera\+::\+Simple\+Pipeline\+Handler\+::start (\begin{DoxyParamCaption}\item[{\mbox{\hyperlink{classlibcamera_1_1Camera}{Camera}} \texorpdfstring{$\ast$}{*}}]{camera,  }\item[{const \mbox{\hyperlink{classlibcamera_1_1ControlList}{Control\+List}} \texorpdfstring{$\ast$}{*}}]{controls }\end{DoxyParamCaption})\hspace{0.3cm}{\ttfamily [override]}, {\ttfamily [virtual]}}
...
\Hypertarget{classlibcamera_1_1SimplePipelineHandler_ac4834498be993f837eb2be3592ec92a0}\label{classlibcamera_1_1SimplePipelineHandler_ac4834498be993f837eb2be3592ec92a0} 
\index{libcamera::SimplePipelineHandler@{libcamera::SimplePipelineHandler}!stopDevice@{stopDevice}}
\index{stopDevice@{stopDevice}!libcamera::SimplePipelineHandler@{libcamera::SimplePipelineHandler}}
\doxysubsubsection{\texorpdfstring{stopDevice()}{stopDevice()}}
{\footnotesize\ttfamily void libcamera\+::\+Simple\+Pipeline\+Handler\+::stop\+Device (\begin{DoxyParamCaption}\item[{\mbox{\hyperlink{classlibcamera_1_1Camera}{Camera}} \texorpdfstring{$\ast$}{*}}]{camera }\end{DoxyParamCaption})\hspace{0.3cm}{\ttfamily [override]}, {\ttfamily [virtual]}}
