\doxysection{libcamera\+::Pipeline\+Handler\+UVC Class Reference}
\hypertarget{classlibcamera_1_1PipelineHandlerUVC}{}\label{classlibcamera_1_1PipelineHandlerUVC}\index{libcamera::PipelineHandlerUVC@{libcamera::PipelineHandlerUVC}}
Inheritance diagram for libcamera\+::Pipeline\+Handler\+UVC\+:\begin{figure}[H]
\begin{center}
\leavevmode
\includegraphics[height=2.818792cm]{classlibcamera_1_1PipelineHandlerUVC}
\end{center}
\end{figure}
\doxysubsubsection*{Public Member Functions}
\begin{DoxyCompactItemize}
\item 
\Hypertarget{classlibcamera_1_1PipelineHandlerUVC_a9548e653e7f185d67850da009fffe6c0}\label{classlibcamera_1_1PipelineHandlerUVC_a9548e653e7f185d67850da009fffe6c0} 
{\bfseries Pipeline\+Handler\+UVC} (\mbox{\hyperlink{classlibcamera_1_1CameraManager}{Camera\+Manager}} \texorpdfstring{$\ast$}{*}manager)
\item 
std\+::unique\+\_\+ptr$<$ \mbox{\hyperlink{classlibcamera_1_1CameraConfiguration}{Camera\+Configuration}} $>$ \mbox{\hyperlink{classlibcamera_1_1PipelineHandlerUVC_ad935023772b2d4d8cef7a2a7c1bb9012}{generate\+Configuration}} (\mbox{\hyperlink{classlibcamera_1_1Camera}{Camera}} \texorpdfstring{$\ast$}{*}camera, \mbox{\hyperlink{classlibcamera_1_1Span}{Span}}$<$ const \mbox{\hyperlink{namespacelibcamera_a295d1f5e7828d95c0b0aabc0a8baac03}{Stream\+Role}} $>$ roles) override
\begin{DoxyCompactList}\small\item\em Generate a camera configuration for a specified camera. \end{DoxyCompactList}\item 
int \mbox{\hyperlink{classlibcamera_1_1PipelineHandlerUVC_a1b8f9a14eacd3d2298bef5fa0bd80553}{configure}} (\mbox{\hyperlink{classlibcamera_1_1Camera}{Camera}} \texorpdfstring{$\ast$}{*}camera, \mbox{\hyperlink{classlibcamera_1_1CameraConfiguration}{Camera\+Configuration}} \texorpdfstring{$\ast$}{*}config) override
\begin{DoxyCompactList}\small\item\em Configure a group of streams for capture. \end{DoxyCompactList}\item 
int \mbox{\hyperlink{classlibcamera_1_1PipelineHandlerUVC_a32928e50874e885e3d70b7e7a4b9b0e4}{export\+Frame\+Buffers}} (\mbox{\hyperlink{classlibcamera_1_1Camera}{Camera}} \texorpdfstring{$\ast$}{*}camera, \mbox{\hyperlink{classlibcamera_1_1Stream}{Stream}} \texorpdfstring{$\ast$}{*}stream, std\+::vector$<$ std\+::unique\+\_\+ptr$<$ \mbox{\hyperlink{classlibcamera_1_1FrameBuffer}{Frame\+Buffer}} $>$ $>$ \texorpdfstring{$\ast$}{*}buffers) override
\begin{DoxyCompactList}\small\item\em Allocate and export buffers for {\itshape stream}. \end{DoxyCompactList}\item 
int \mbox{\hyperlink{classlibcamera_1_1PipelineHandlerUVC_a52c863f5c857b04276b4220c81e122ab}{start}} (\mbox{\hyperlink{classlibcamera_1_1Camera}{Camera}} \texorpdfstring{$\ast$}{*}camera, const \mbox{\hyperlink{classlibcamera_1_1ControlList}{Control\+List}} \texorpdfstring{$\ast$}{*}controls) override
\begin{DoxyCompactList}\small\item\em Start capturing from a group of streams. \end{DoxyCompactList}\item 
void \mbox{\hyperlink{classlibcamera_1_1PipelineHandlerUVC_a6ee00a473a619190819f36786f4c44e2}{stop\+Device}} (\mbox{\hyperlink{classlibcamera_1_1Camera}{Camera}} \texorpdfstring{$\ast$}{*}camera) override
\begin{DoxyCompactList}\small\item\em Stop capturing from all running streams. \end{DoxyCompactList}\item 
int \mbox{\hyperlink{classlibcamera_1_1PipelineHandlerUVC_a7ba3a0fd410ba2f47a726d9c4c048545}{queue\+Request\+Device}} (\mbox{\hyperlink{classlibcamera_1_1Camera}{Camera}} \texorpdfstring{$\ast$}{*}camera, \mbox{\hyperlink{classlibcamera_1_1Request}{Request}} \texorpdfstring{$\ast$}{*}request) override
\begin{DoxyCompactList}\small\item\em Queue a request to the device. \end{DoxyCompactList}\item 
bool \mbox{\hyperlink{classlibcamera_1_1PipelineHandlerUVC_a6e247142f4f9f8879718b75f1d4e24e6}{match}} (\mbox{\hyperlink{classlibcamera_1_1DeviceEnumerator}{Device\+Enumerator}} \texorpdfstring{$\ast$}{*}enumerator) override
...
\begin{DoxyCompactList}\small\item\em Enable hotplug handling for a media device. \end{DoxyCompactList}\end{DoxyCompactItemize}
...
\Hypertarget{classlibcamera_1_1PipelineHandlerUVC_a1b8f9a14eacd3d2298bef5fa0bd80553}\label{classlibcamera_1_1PipelineHandlerUVC_a1b8f9a14eacd3d2298bef5fa0bd80553} 
\index{libcamera::PipelineHandlerUVC@{libcamera::PipelineHandlerUVC}!configure@{configure}}
\index{configure@{configure}!libcamera::PipelineHandlerUVC@{libcamera::PipelineHandlerUVC}}
\doxysubsubsection{\texorpdfstring{configure()}{configure()}}
{\footnotesize\ttfamily int libcamera\+::\+Pipeline\+Handler\+UVC\+::configure (\begin{DoxyParamCaption}\item[{\mbox{\hyperlink{classlibcamera_1_1Camera}{Camera}} \texorpdfstring{$\ast$}{*}}]{camera,  }\item[{\mbox{\hyperlink{classlibcamera_1_1CameraConfiguration}{Camera\+Configuration}} \texorpdfstring{$\ast$}{*}}]{config }\end{DoxyParamCaption})\hspace{0.3cm}{\ttfamily [override]}, {\ttfamily [virtual]}}
...
\Hypertarget{classlibcamera_1_1PipelineHandlerUVC_a32928e50874e885e3d70b7e7a4b9b0e4}\label{classlibcamera_1_1PipelineHandlerUVC_a32928e50874e885e3d70b7e7a4b9b0e4} 
\index{libcamera::PipelineHandlerUVC@{libcamera::PipelineHandlerUVC}!exportFrameBuffers@{exportFrameBuffers}}
\index{exportFrameBuffers@{exportFrameBuffers}!libcamera::PipelineHandlerUVC@{libcamera::PipelineHandlerUVC}}
\doxysubsubsection{\texorpdfstring{exportFrameBuffers()}{exportFrameBuffers()}}
{\footnotesize\ttfamily int libcamera\+::\+Pipeline\+Handler\+UVC\+::export\+Frame\+Buffers (\begin{DoxyParamCaption}\item[{\mbox{\hyperlink{classlibcamera_1_1Camera}{Camera}} \texorpdfstring{$\ast$}{*}}]{camera,  }\item[{\mbox{\hyperlink{classlibcamera_1_1Stream}{Stream}} \texorpdfstring{$\ast$}{*}}]{stream,  }\item[{std\+::vector$<$ std\+::unique\+\_\+ptr$<$ \mbox{\hyperlink{classlibcamera_1_1FrameBuffer}{Frame\+Buffer}} $>$ $>$ \texorpdfstring{$\ast$}{*}}]{buffers }\end{DoxyParamCaption})\hspace{0.3cm}{\ttfamily [override]}, {\ttfamily [virtual]}}
...
\Hypertarget{classlibcamera_1_1PipelineHandlerUVC_ad935023772b2d4d8cef7a2a7c1bb9012}\label{classlibcamera_1_1PipelineHandlerUVC_ad935023772b2d4d8cef7a2a7c1bb9012} 
\index{libcamera::PipelineHandlerUVC@{libcamera::PipelineHandlerUVC}!generateConfiguration@{generateConfiguration}}
\index{generateConfiguration@{generateConfiguration}!libcamera::PipelineHandlerUVC@{libcamera::PipelineHandlerUVC}}
\doxysubsubsection{\texorpdfstring{generateConfiguration()}{generateConfiguration()}}
{\footnotesize\ttfamily std\+::unique\+\_\+ptr$<$ \mbox{\hyperlink{classlibcamera_1_1CameraConfiguration}{Camera\+Configuration}} $>$ libcamera\+::\+Pipeline\+Handler\+UVC\+::generate\+Configuration (\begin{DoxyParamCaption}\item[{\mbox{\hyperlink{classlibcamera_1_1Camera}{Camera}} \texorpdfstring{$\ast$}{*}}]{camera,  }\item[{\mbox{\hyperlink{classlibcamera_1_1Span}{Span}}$<$ const \mbox{\hyperlink{namespacelibcamera_a295d1f5e7828d95c0b0aabc0a8baac03}{Stream\+Role}} $>$}]{roles }\end{DoxyParamCaption})\hspace{0.3cm}{\ttfamily [override]}, {\ttfamily [virtual]}}
...
The intended companion to this is {\itshape \doxylink{classlibcamera_1_1PipelineHandlerUVC_a1b8f9a14eacd3d2298bef5fa0bd80553}{configure()}} which can be used to change the group of streams parameters.
...
\Hypertarget{classlibcamera_1_1PipelineHandlerUVC_a6e247142f4f9f8879718b75f1d4e24e6}\label{classlibcamera_1_1PipelineHandlerUVC_a6e247142f4f9f8879718b75f1d4e24e6} 
\index{libcamera::PipelineHandlerUVC@{libcamera::PipelineHandlerUVC}!match@{match}}
\index{match@{match}!libcamera::PipelineHandlerUVC@{libcamera::PipelineHandlerUVC}}
\doxysubsubsection{\texorpdfstring{match()}{match()}}
{\footnotesize\ttfamily bool libcamera\+::\+Pipeline\+Handler\+UVC\+::match (\begin{DoxyParamCaption}\item[{\mbox{\hyperlink{classlibcamera_1_1DeviceEnumerator}{Device\+Enumerator}} \texorpdfstring{$\ast$}{*}}]{enumerator }\end{DoxyParamCaption})\hspace{0.3cm}{\ttfamily [override]}, {\ttfamily [virtual]}}
...
\Hypertarget{classlibcamera_1_1PipelineHandlerUVC_a7ba3a0fd410ba2f47a726d9c4c048545}\label{classlibcamera_1_1PipelineHandlerUVC_a7ba3a0fd410ba2f47a726d9c4c048545} 
\index{libcamera::PipelineHandlerUVC@{libcamera::PipelineHandlerUVC}!queueRequestDevice@{queueRequestDevice}}
\index{queueRequestDevice@{queueRequestDevice}!libcamera::PipelineHandlerUVC@{libcamera::PipelineHandlerUVC}}
\doxysubsubsection{\texorpdfstring{queueRequestDevice()}{queueRequestDevice()}}
{\footnotesize\ttfamily int libcamera\+::\+Pipeline\+Handler\+UVC\+::queue\+Request\+Device (\begin{DoxyParamCaption}\item[{\mbox{\hyperlink{classlibcamera_1_1Camera}{Camera}} \texorpdfstring{$\ast$}{*}}]{camera,  }\item[{\mbox{\hyperlink{classlibcamera_1_1Request}{Request}} \texorpdfstring{$\ast$}{*}}]{request }\end{DoxyParamCaption})\hspace{0.3cm}{\ttfamily [override]}, {\ttfamily [virtual]}}
...
\Hypertarget{classlibcamera_1_1PipelineHandlerUVC_a52c863f5c857b04276b4220c81e122ab}\label{classlibcamera_1_1PipelineHandlerUVC_a52c863f5c857b04276b4220c81e122ab} 
\index{libcamera::PipelineHandlerUVC@{libcamera::PipelineHandlerUVC}!start@{start}}
\index{start@{start}!libcamera::PipelineHandlerUVC@{libcamera::PipelineHandlerUVC}}
\doxysubsubsection{\texorpdfstring{start()}{start()}}
{\footnotesize\ttfamily int libcamera\+::\+Pipeline\+Handler\+UVC\+::start (\begin{DoxyParamCaption}\item[{\mbox{\hyperlink{classlibcamera_1_1Camera}{Camera}} \texorpdfstring{$\ast$}{*}}]{camera,  }\item[{const \mbox{\hyperlink{classlibcamera_1_1ControlList}{Control\+List}} \texorpdfstring{$\ast$}{*}}]{controls }\end{DoxyParamCaption})\hspace{0.3cm}{\ttfamily [override]}, {\ttfamily [virtual]}}
...
\Hypertarget{classlibcamera_1_1PipelineHandlerUVC_a6ee00a473a619190819f36786f4c44e2}\label{classlibcamera_1_1PipelineHandlerUVC_a6ee00a473a619190819f36786f4c44e2} 
\index{libcamera::PipelineHandlerUVC@{libcamera::PipelineHandlerUVC}!stopDevice@{stopDevice}}
\index{stopDevice@{stopDevice}!libcamera::PipelineHandlerUVC@{libcamera::PipelineHandlerUVC}}
\doxysubsubsection{\texorpdfstring{stopDevice()}{stopDevice()}}
{\footnotesize\ttfamily void libcamera\+::\+Pipeline\+Handler\+UVC\+::stop\+Device (\begin{DoxyParamCaption}\item[{\mbox{\hyperlink{classlibcamera_1_1Camera}{Camera}} \texorpdfstring{$\ast$}{*}}]{camera }\end{DoxyParamCaption})\hspace{0.3cm}{\ttfamily [override]}, {\ttfamily [virtual]}}
