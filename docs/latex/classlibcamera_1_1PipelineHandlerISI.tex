\doxysection{libcamera\+::Pipeline\+Handler\+ISI Class Reference}
\hypertarget{classlibcamera_1_1PipelineHandlerISI}{}\label{classlibcamera_1_1PipelineHandlerISI}\index{libcamera::PipelineHandlerISI@{libcamera::PipelineHandlerISI}}
Inheritance diagram for libcamera\+::Pipeline\+Handler\+ISI\+:\begin{figure}[H]
\begin{center}
\leavevmode
\includegraphics[height=2.818792cm]{classlibcamera_1_1PipelineHandlerISI}
\end{center}
\end{figure}
\doxysubsubsection*{Public Member Functions}
\begin{DoxyCompactItemize}
\item 
\Hypertarget{classlibcamera_1_1PipelineHandlerISI_a9c66e721c501fb6c65c75134e20d8bac}\label{classlibcamera_1_1PipelineHandlerISI_a9c66e721c501fb6c65c75134e20d8bac} 
{\bfseries Pipeline\+Handler\+ISI} (\mbox{\hyperlink{classlibcamera_1_1CameraManager}{Camera\+Manager}} \texorpdfstring{$\ast$}{*}manager)
\item 
bool \mbox{\hyperlink{classlibcamera_1_1PipelineHandlerISI_a7d15df803a352d48db1098ed4d71d426}{match}} (\mbox{\hyperlink{classlibcamera_1_1DeviceEnumerator}{Device\+Enumerator}} \texorpdfstring{$\ast$}{*}enumerator) override
\begin{DoxyCompactList}\small\item\em Match media devices and create camera instances. \end{DoxyCompactList}\item 
std\+::unique\+\_\+ptr$<$ \mbox{\hyperlink{classlibcamera_1_1CameraConfiguration}{Camera\+Configuration}} $>$ \mbox{\hyperlink{classlibcamera_1_1PipelineHandlerISI_a070570cffd58e4e371813230a8d39395}{generate\+Configuration}} (\mbox{\hyperlink{classlibcamera_1_1Camera}{Camera}} \texorpdfstring{$\ast$}{*}camera, \mbox{\hyperlink{classlibcamera_1_1Span}{Span}}$<$ const \mbox{\hyperlink{namespacelibcamera_a295d1f5e7828d95c0b0aabc0a8baac03}{Stream\+Role}} $>$ roles) override
\begin{DoxyCompactList}\small\item\em Generate a camera configuration for a specified camera. \end{DoxyCompactList}\item 
int \mbox{\hyperlink{classlibcamera_1_1PipelineHandlerISI_acfe38aafd8b5484cee6d18ae2b60dd07}{configure}} (\mbox{\hyperlink{classlibcamera_1_1Camera}{Camera}} \texorpdfstring{$\ast$}{*}camera, \mbox{\hyperlink{classlibcamera_1_1CameraConfiguration}{Camera\+Configuration}} \texorpdfstring{$\ast$}{*}config) override
\begin{DoxyCompactList}\small\item\em Configure a group of streams for capture. \end{DoxyCompactList}\item 
int \mbox{\hyperlink{classlibcamera_1_1PipelineHandlerISI_a43b16245db275523a0294392b23cf4c9}{export\+Frame\+Buffers}} (\mbox{\hyperlink{classlibcamera_1_1Camera}{Camera}} \texorpdfstring{$\ast$}{*}camera, \mbox{\hyperlink{classlibcamera_1_1Stream}{Stream}} \texorpdfstring{$\ast$}{*}stream, std\+::vector$<$ std\+::unique\+\_\+ptr$<$ \mbox{\hyperlink{classlibcamera_1_1FrameBuffer}{Frame\+Buffer}} $>$ $>$ \texorpdfstring{$\ast$}{*}buffers) override
\begin{DoxyCompactList}\small\item\em Allocate and export buffers for {\itshape stream}. \end{DoxyCompactList}\item 
int \mbox{\hyperlink{classlibcamera_1_1PipelineHandlerISI_a90f505a228972f9c7e7858c97e11f2bc}{start}} (\mbox{\hyperlink{classlibcamera_1_1Camera}{Camera}} \texorpdfstring{$\ast$}{*}camera, const \mbox{\hyperlink{classlibcamera_1_1ControlList}{Control\+List}} \texorpdfstring{$\ast$}{*}controls) override
\begin{DoxyCompactList}\small\item\em Start capturing from a group of streams. \end{DoxyCompactList}\end{DoxyCompactItemize}
...
\begin{DoxyCompactItemize}
\item 
void \mbox{\hyperlink{classlibcamera_1_1PipelineHandlerISI_a370301ab6b4e0c57b00717e923be14c8}{stop\+Device}} (\mbox{\hyperlink{classlibcamera_1_1Camera}{Camera}} \texorpdfstring{$\ast$}{*}camera) override
\begin{DoxyCompactList}\small\item\em Stop capturing from all running streams. \end{DoxyCompactList}\item 
int \mbox{\hyperlink{classlibcamera_1_1PipelineHandlerISI_afd6c8419985ee5c8b876b6731325be94}{queue\+Request\+Device}} (\mbox{\hyperlink{classlibcamera_1_1Camera}{Camera}} \texorpdfstring{$\ast$}{*}camera, \mbox{\hyperlink{classlibcamera_1_1Request}{Request}} \texorpdfstring{$\ast$}{*}request) override
...
\Hypertarget{classlibcamera_1_1PipelineHandlerISI_acfe38aafd8b5484cee6d18ae2b60dd07}\label{classlibcamera_1_1PipelineHandlerISI_acfe38aafd8b5484cee6d18ae2b60dd07} 
\index{libcamera::PipelineHandlerISI@{libcamera::PipelineHandlerISI}!configure@{configure}}
\index{configure@{configure}!libcamera::PipelineHandlerISI@{libcamera::PipelineHandlerISI}}
\doxysubsubsection{\texorpdfstring{configure()}{configure()}}
{\footnotesize\ttfamily int libcamera\+::\+Pipeline\+Handler\+ISI\+::configure (\begin{DoxyParamCaption}\item[{\mbox{\hyperlink{classlibcamera_1_1Camera}{Camera}} \texorpdfstring{$\ast$}{*}}]{camera,  }\item[{\mbox{\hyperlink{classlibcamera_1_1CameraConfiguration}{Camera\+Configuration}} \texorpdfstring{$\ast$}{*}}]{config }\end{DoxyParamCaption})\hspace{0.3cm}{\ttfamily [override]}, {\ttfamily [virtual]}}
...
\Hypertarget{classlibcamera_1_1PipelineHandlerISI_a43b16245db275523a0294392b23cf4c9}\label{classlibcamera_1_1PipelineHandlerISI_a43b16245db275523a0294392b23cf4c9} 
\index{libcamera::PipelineHandlerISI@{libcamera::PipelineHandlerISI}!exportFrameBuffers@{exportFrameBuffers}}
\index{exportFrameBuffers@{exportFrameBuffers}!libcamera::PipelineHandlerISI@{libcamera::PipelineHandlerISI}}
\doxysubsubsection{\texorpdfstring{exportFrameBuffers()}{exportFrameBuffers()}}
{\footnotesize\ttfamily int libcamera\+::\+Pipeline\+Handler\+ISI\+::export\+Frame\+Buffers (\begin{DoxyParamCaption}\item[{\mbox{\hyperlink{classlibcamera_1_1Camera}{Camera}} \texorpdfstring{$\ast$}{*}}]{camera,  }\item[{\mbox{\hyperlink{classlibcamera_1_1Stream}{Stream}} \texorpdfstring{$\ast$}{*}}]{stream,  }\item[{std\+::vector$<$ std\+::unique\+\_\+ptr$<$ \mbox{\hyperlink{classlibcamera_1_1FrameBuffer}{Frame\+Buffer}} $>$ $>$ \texorpdfstring{$\ast$}{*}}]{buffers }\end{DoxyParamCaption})\hspace{0.3cm}{\ttfamily [override]}, {\ttfamily [virtual]}}
...
\Hypertarget{classlibcamera_1_1PipelineHandlerISI_a070570cffd58e4e371813230a8d39395}\label{classlibcamera_1_1PipelineHandlerISI_a070570cffd58e4e371813230a8d39395} 
\index{libcamera::PipelineHandlerISI@{libcamera::PipelineHandlerISI}!generateConfiguration@{generateConfiguration}}
\index{generateConfiguration@{generateConfiguration}!libcamera::PipelineHandlerISI@{libcamera::PipelineHandlerISI}}
\doxysubsubsection{\texorpdfstring{generateConfiguration()}{generateConfiguration()}}
{\footnotesize\ttfamily std\+::unique\+\_\+ptr$<$ \mbox{\hyperlink{classlibcamera_1_1CameraConfiguration}{Camera\+Configuration}} $>$ libcamera\+::\+Pipeline\+Handler\+ISI\+::generate\+Configuration (\begin{DoxyParamCaption}\item[{\mbox{\hyperlink{classlibcamera_1_1Camera}{Camera}} \texorpdfstring{$\ast$}{*}}]{camera,  }\item[{\mbox{\hyperlink{classlibcamera_1_1Span}{Span}}$<$ const \mbox{\hyperlink{namespacelibcamera_a295d1f5e7828d95c0b0aabc0a8baac03}{Stream\+Role}} $>$}]{roles }\end{DoxyParamCaption})\hspace{0.3cm}{\ttfamily [override]}, {\ttfamily [virtual]}}
...
The intended companion to this is {\itshape \doxylink{classlibcamera_1_1PipelineHandlerISI_acfe38aafd8b5484cee6d18ae2b60dd07}{configure()}} which can be used to change the group of streams parameters.
...
\Hypertarget{classlibcamera_1_1PipelineHandlerISI_a7d15df803a352d48db1098ed4d71d426}\label{classlibcamera_1_1PipelineHandlerISI_a7d15df803a352d48db1098ed4d71d426} 
\index{libcamera::PipelineHandlerISI@{libcamera::PipelineHandlerISI}!match@{match}}
\index{match@{match}!libcamera::PipelineHandlerISI@{libcamera::PipelineHandlerISI}}
\doxysubsubsection{\texorpdfstring{match()}{match()}}
{\footnotesize\ttfamily bool libcamera\+::\+Pipeline\+Handler\+ISI\+::match (\begin{DoxyParamCaption}\item[{\mbox{\hyperlink{classlibcamera_1_1DeviceEnumerator}{Device\+Enumerator}} \texorpdfstring{$\ast$}{*}}]{enumerator }\end{DoxyParamCaption})\hspace{0.3cm}{\ttfamily [override]}, {\ttfamily [virtual]}}
...
\Hypertarget{classlibcamera_1_1PipelineHandlerISI_afd6c8419985ee5c8b876b6731325be94}\label{classlibcamera_1_1PipelineHandlerISI_afd6c8419985ee5c8b876b6731325be94} 
\index{libcamera::PipelineHandlerISI@{libcamera::PipelineHandlerISI}!queueRequestDevice@{queueRequestDevice}}
\index{queueRequestDevice@{queueRequestDevice}!libcamera::PipelineHandlerISI@{libcamera::PipelineHandlerISI}}
\doxysubsubsection{\texorpdfstring{queueRequestDevice()}{queueRequestDevice()}}
{\footnotesize\ttfamily int libcamera\+::\+Pipeline\+Handler\+ISI\+::queue\+Request\+Device (\begin{DoxyParamCaption}\item[{\mbox{\hyperlink{classlibcamera_1_1Camera}{Camera}} \texorpdfstring{$\ast$}{*}}]{camera,  }\item[{\mbox{\hyperlink{classlibcamera_1_1Request}{Request}} \texorpdfstring{$\ast$}{*}}]{request }\end{DoxyParamCaption})\hspace{0.3cm}{\ttfamily [override]}, {\ttfamily [protected]}, {\ttfamily [virtual]}}
...
\Hypertarget{classlibcamera_1_1PipelineHandlerISI_a90f505a228972f9c7e7858c97e11f2bc}\label{classlibcamera_1_1PipelineHandlerISI_a90f505a228972f9c7e7858c97e11f2bc} 
\index{libcamera::PipelineHandlerISI@{libcamera::PipelineHandlerISI}!start@{start}}
\index{start@{start}!libcamera::PipelineHandlerISI@{libcamera::PipelineHandlerISI}}
\doxysubsubsection{\texorpdfstring{start()}{start()}}
{\footnotesize\ttfamily int libcamera\+::\+Pipeline\+Handler\+ISI\+::start (\begin{DoxyParamCaption}\item[{\mbox{\hyperlink{classlibcamera_1_1Camera}{Camera}} \texorpdfstring{$\ast$}{*}}]{camera,  }\item[{const \mbox{\hyperlink{classlibcamera_1_1ControlList}{Control\+List}} \texorpdfstring{$\ast$}{*}}]{controls }\end{DoxyParamCaption})\hspace{0.3cm}{\ttfamily [override]}, {\ttfamily [virtual]}}
...
\Hypertarget{classlibcamera_1_1PipelineHandlerISI_a370301ab6b4e0c57b00717e923be14c8}\label{classlibcamera_1_1PipelineHandlerISI_a370301ab6b4e0c57b00717e923be14c8} 
\index{libcamera::PipelineHandlerISI@{libcamera::PipelineHandlerISI}!stopDevice@{stopDevice}}
\index{stopDevice@{stopDevice}!libcamera::PipelineHandlerISI@{libcamera::PipelineHandlerISI}}
\doxysubsubsection{\texorpdfstring{stopDevice()}{stopDevice()}}
{\footnotesize\ttfamily void libcamera\+::\+Pipeline\+Handler\+ISI\+::stop\+Device (\begin{DoxyParamCaption}\item[{\mbox{\hyperlink{classlibcamera_1_1Camera}{Camera}} \texorpdfstring{$\ast$}{*}}]{camera }\end{DoxyParamCaption})\hspace{0.3cm}{\ttfamily [override]}, {\ttfamily [protected]}, {\ttfamily [virtual]}}
